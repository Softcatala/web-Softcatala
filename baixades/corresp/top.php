...
echo '';
echo '<table width="145" border="0" cellspacing="2" cellpadding="2" align="center">';
...
echo '  <tr>
    <td width="121" bgcolor="#CCCC99"><font face="Verdana, Arial, Helvetica, sans-serif"><strong>'.$num.'</strong>&nbsp;<a href = "http://www.softcatala.org/wiki/'.$urlprog.'">'.$nom.'</a> </font></td>
    <td width="22" valign="top" bgcolor="#CCCC99">
      <div align="right"><font color="#CCCC99" face="Verdana, Arial, Helvetica, sans-serif"><font class="Txt-miniColor">'.$listcount[$i].'</font></font></div>
    </td>
  </tr>
';
