...
echo '<span class="numtop">'.$num.'.</span> <span class="linktop"><a href = "http://www.softcatala.org/wiki/'.$urlprog.'" target="_parent">'.$nom.'</a> <span class="red">('.$listcount[$i].')</span></span></li>';
...
echo '<program>';
echo '<rank>'.$num.'</rank>';
echo '<url>https://www.softcatala.org/wiki/'.$urlprog.'</url>';
echo '<name>'.$nom.'</name>';
